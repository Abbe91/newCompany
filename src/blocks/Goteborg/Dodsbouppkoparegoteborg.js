...
const Dodsbouppkoparegoteborg = ({ videoText }) => {
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline:
      "Centrum för alla vi hjälper dig med städning, flytt, tömning, bortforsling och värdering av dödsbo och hushåll samt återvinning och avfallshantering",
    description:
      "Behöver du hjälp med flytt, städning eller tömning av dödsbo? Välkommen till vår Centrum för alla där vi erbjuder allt från bortforsling och värdering till uppköp av dödsbo och hushåll. Vi tar hand om både små och stora projekt, från kontor och lägenheter till fastigheter och hus. Kontakta oss idag för en smidig och stressfri lösning. Vi hjälper även till med återvinning och avfallshantering",
    image:
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/dodsbo-uppkopare-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
