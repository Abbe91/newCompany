...
const Webbdesign = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "webbdesign";
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/webbdesign"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Hem">
        <MainComp
          ...
          text2={`* Djupgående kunskap om webbdesign`}
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna webbdesignspecialister med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin webbplats design och funktionalitet genom pålitliga webbdesigntjänster.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri webbdesignanalys och upptäck hur du kan
