...
const Seogoteborg = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "SEO i Göteborg";
  const newsData = useSelector(getNewsData);
  const [content, setContent] = useState({
    metaTitle: "SEO - Bli synlig på Google i Göteborg",
    metaContent:
      "Vill du öka din webbplats trafik och konverteringar i Göteborg? Våra SEO-experter hjälper dig att nå toppen på sökmotorerna.",
    query: "SEO Göteborg",
    formTitle: "Få en kostnadsfri SEO-analys för din webbplats i Göteborg",
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/seo-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Hem">
        <MainComp
          ...
          text={`Låt oss ta hand om din ${mainquery}. Med vår expertis och erfarenhet kan du känna dig trygg med att din webbplats är i goda händer. Vi erbjuder en helhetslösning som inkluderar allt från keyword research till teknisk SEO. Vårt mål är att hjälpa dig att nå toppen på sökmotorerna.`}
          subTitle4={`Experter på ${mainquery}`}
          text1={`Varför välja oss?`}
          text2={`* Djupgående kunskap om sökmotoroptimering`}
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna SEO-specialister med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin synlighet på sökmotorerna och öka sin online-försäljning.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri SEO-analys och upptäck hur du kan öka din
