...
const Innehallsmarknadsforing = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "innehållsmarknadsföring";
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/innehallsmarknadsforing"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Hem">
        <MainComp
          ...
          text2={`* Djupgående kunskap om innehållsmarknadsföring`}
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna innehållsmarknadsföringsspecialister med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin synlighet och engagemang genom effektiv innehållsmarknadsföring.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri analys av din innehållsstrategi och upptäck hur
            du kan öka din online-synlighet och generera mer trafik.
          </h4>
...
export default Innehallsmarknadsforing;
