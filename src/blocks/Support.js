...
const Support = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "support";
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/support"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Hem">
        <MainComp
          ...
          text2={`* Djupgående kunskap om support`}
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna support-specialister med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin webbplats prestanda och tillgänglighet genom pålitliga supporttjänster.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri support-analys och upptäck hur du kan förbättra
