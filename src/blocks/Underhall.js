...
const Underhall = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "underhåll";
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/underhall"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Hem">
        <MainComp
          ...
          text2={`* Djupgående kunskap om underhåll`}
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna underhållsspecialister med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin webbplats prestanda och tillgänglighet genom pålitliga underhållstjänster.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri underhållsanalys och upptäck hur du kan
