    ...
    <section>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/avfallshantering"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div class="flex-column-container-waste-disposal">
        ...
        <div class="waste-disposal-best-practices">
          ...
          <ol>
            ...
            <p>
              Vi på Centrum för alla erbjuder professionell
              avfallshanteringstjänst som kan hjälpa dig att återvinna på bästa
              sätt och minska din påverkan på miljön. Vi erbjuder
              avfallssortering, transport och återvinning av olika typer av
              avfall för att minimera miljöpåverkan och främja en hållbar
              framtid. Kontakta oss idag för att ta reda på hur vi kan hjälpa
              dig med din avfallshantering och bidra till en bättre miljö för
              oss alla.
            </p>
          </ol>
        </div>
        <div class="waste-disposal-services-description">
          ...
          <p>
            Centrum för alla är din bästa partner när det gäller
            avfallshantering. Vi har många års erfarenhet av att hantera avfall
            i samband med dödsbon, och vi kan hjälpa dig att ta hand om allt
            avfall på ett säkert och effektivt sätt. När en älskad person går
            bort kan det vara överväldigande att ta hand om allt avfall som
            samlas upp. Det kan vara allt från kläder, möbler och elektronik
            till farliga kemikalier och mediciner. Centrum för alla kan hjälpa
            till att sortera, transportera och återvinna allt avfall på ett sätt
            som är säkert för miljön och människor. Vi på Centrum för alla har
            de rätta verktygen och expertisen för att hantera alla typer av
            avfall. Vi kan också hantera farligt avfall, såsom mediciner och
            kemikalier, på ett säkert och lagligt sätt. Vi arbetar nära våra
            kunder för att säkerställa att deras behov och önskemål tas om hand
            på ett effektivt och smidigt sätt. Våra tjänster är prisvärda och vi
            kan erbjuda skräddarsydda lösningar för varje kunds unika behov. Vi
            tar hand om allt, från avfallssortering och transport till
