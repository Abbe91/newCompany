...
const Ppcannonsering = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "PPC-annonsering";
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/ppc-annonsering"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna PPC-annonsering-specialister med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin annonseringsstrategi och nå fler kunder genom effektiva PPC-kampanjer.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri PPC-annonseringsanalys och upptäck hur du kan
