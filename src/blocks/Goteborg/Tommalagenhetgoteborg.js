...
const Tommalagenhetgoteborg = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    metaContent:
      "Behöver du hjälp med att tömma en lägenhet i Göteborg? Då är vi på Centrum för alla det självklara valet. Vi tömmer lägenheter i Göteborg med omnejd.",
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/tomma-lagenhet/tomma-lagenhet-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
