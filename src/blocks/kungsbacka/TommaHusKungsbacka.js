...
const TommaHusKungsbacka = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    metaContent:
      "Behöver du hjälp med att Tömma hus i Kungsbacka? Vi på Centrum för alla hjälper dig med att tömma ert hus i Kungsbacka.",
  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://centrumforalla.se/tomma-hus/tomma-hus-kungsbacka"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
