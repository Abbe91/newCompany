...
const Tommahusgoteborg = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    metaContent:
      "Behöver du hjälp med att tömma ett hus i Göteborg? Då är vi på Centrum för alla det självklara valet. Vi tömmer hus i Göteborg med omnejd.",
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/tomma-hus/tomma-hus-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
