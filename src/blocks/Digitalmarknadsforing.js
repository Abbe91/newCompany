...
const Digitalmarknadsforing = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "digital marknadsföring";
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://centrumforalla.se/digital-marknadsforing"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      <div className="Hem">
        <MainComp
          ...
          text={`Låt oss ta hand om din ${mainquery}. Med vår expertis och erfarenhet kan du känna dig trygg med att din digitala marknadsföring är i goda händer. Vi erbjuder en helhetslösning som inkluderar allt från strategiutveckling till genomförande. Vårt mål är att hjälpa dig att öka din online-närvaro och nå fler kunder.`}
          subTitle4={`Experter på ${mainquery}`}
          text1={`Varför välja oss?`}
          text2={`* Djupgående kunskap om digital marknadsföring`}
      ...
      <div className="Om">
        <AboutUs
          ...
          oss={`Vem är vi? Vi är ett team av erfarna specialister inom digital marknadsföring med en passion för att hjälpa företag att nå sina digitala mål.`}
          om={`Med över 20 års erfarenhet inom branschen har vi hjälpt hundratals företag att förbättra sin online-närvaro och nå fler kunder genom effektiva digitala marknadsföringsstrategier.`}
        />
      </div>
      {newsData && (
        <div className="Tips">
      ...
      <div className="booking-lottie">
        <div className="booking-content">
          ...
          <h4>
            Boka en kostnadsfri analys av din digitala marknadsföring och
            upptäck hur du kan förbättra din online-närvaro och generera mer
            trafik.
          </h4>
