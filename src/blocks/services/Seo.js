...
const SeoService = () => {
  const serviceData = {
    ...
    metaContent: "Vill du öka din webbplats trafik och konverteringar? Våra SEO-experter hjälper dig att nå toppen på sökmotorerna.",
    query: `SEO tjänster`,
    city: "", 
    ...
    aboutUsText:
      `Vi är ledande inom SEO och har hjälpt många företag att förbättra sin synlighet online och öka sin försäljning.`,
